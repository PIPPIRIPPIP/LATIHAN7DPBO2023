...
public class Game extends Canvas implements Runnable
{
    ...
    public Game()
    {
        ...
        {
            // Initialize display.
            display = new Display(width, height, "LP7DPO2022");
            display.open(this); 
            ...
            if(running)
            {
                ...
                handler.add(new Food(rand.nextInt(480), rand.nextInt(640)));
            }
        } catch(Exception e)
        {
    ...
    public void render()
    {
        ...
        if(running == true)
        {
            ...
            g.setColor(Color.white);
            g.drawString("Eat : " + Integer.toString(eat), 20, 50);
        ...
        {   
            ...
            for(int i = 0; i < handler.count(); i++)
            {
                if(handler.get(i).getType().equals("Player"))
                {
                    ...
                    System.out.println("player"+handler.get(i).getX());
                    System.out.println("player"+handler.get(i).getY());
                }
                if(handler.get(i).getType().equals("Food"))
                {
                    System.out.println("food"+handler.get(i).getX());
                    System.out.println("food"+handler.get(i).getY());
...
//                if (handler.get(0).intersects(handler.get(i))) {
//                    Random random = new Random();
//                    int x = random.nextInt(480);
//                    int y = random.nextInt(640);
//                    handler.get(i).setLocation(x, y);
//                }
            }
        }
    }
